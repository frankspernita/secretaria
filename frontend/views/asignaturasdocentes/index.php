...
/* @var $searchModel frontend\models\AsignaturasdocentesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Asignaturas del docente';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="asignaturasdocentes-index">
    <div class="row">
    <div class="col-sm-6">
    <?= DetailView::widget([
        'model' => $modelClient,
...
<?php Pjax::begin(); ?>
        <p>
        <?= Html::a('Cargar Asignatura', ['create' , 'idP' => $idP, 'departamento' => $departamento], ['class' => 'btn btn-success']) ?>
    </p>
