...
<header class="main-header">
   ...
   <?= Html::a('<span class = "logo-mini">'.Html::img('@web/logo/logo.jpg').'</span><span class="logo-lg">'.Html::img('@web/logo/logo.png') . "Secretaria Civil" . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
